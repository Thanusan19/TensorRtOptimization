...
ROOT = '/home/localadmin/Documents/ATTNMPMH_NORMAL/model_ckpt'
PATH = ROOT+'/Best_1S'
...
class ModelData(object):
    MODEL_FILE = "modelATTNMPMH_NORMAL.uff" #"model.uff"
    INPUT_NAME ="inputs"
    INPUT_SHAPE = X.shape[1:]
    OUTPUT_NAME = "outputs/BiasAdd"
...
def main():
	...
	for i in range(inference_Loop):
	    PRED = sess.run('outputs/BiasAdd:0',feed_dict={'inputs:0':X}) #,'hidden_state:0':HS})
	...
	#---------------------------------#
	uff_model = uff.from_tensorflow_frozen_model(ROOT+'/frozen_model.pb',['outputs/BiasAdd'],output_filename = ModelData.MODEL_FILE)
